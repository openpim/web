                ...
                <v-expansion-panel-content>
                  <v-container class="pa-0">
                    <v-row no-gutters>
                      ...
                      <v-col cols="12"><v-textarea rows="5" :readonly="!canEditConfigRef" v-model="selectedRef.config.afterEachRow" :label="$t('ImportConfig.AfterEachRow')" required></v-textarea></v-col>
