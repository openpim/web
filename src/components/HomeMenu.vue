<template>
    ...
    <v-col cols="12">
      ...
      <v-btn small icon fab absolute top right @click="add(false)" v-if="selectedRef && (selectedRef.id === -1 || selectedRef.children)" class="mt-7 mr-1"><v-icon>mdi-plus</v-icon></v-btn>
